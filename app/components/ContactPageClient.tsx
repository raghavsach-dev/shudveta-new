...
export default function ContactPageClient() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // The form will submit to FormSubmit's endpoint
  };
          ...
          {showSuccessMessage && (
            <div className="max-w-4xl mx-auto mb-8">
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="bg-green-50 border-l-4 border-green-500 p-4 rounded-lg shadow-md"
              >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-50 p-8 md:p-12 rounded-2xl shadow-xl border border-gray-100">
              ...
              >
                ...
                <input type="hidden" name="_subject" value="New Contact Form Submission from Shudveta Website" />
                ...
                <div className="text-center">
                  <button
                    ...
                    className="inline-flex items-center px-8 py-4 bg-blue-600 text-white font-semibold text-lg rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
